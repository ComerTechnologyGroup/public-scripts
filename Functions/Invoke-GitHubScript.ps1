...
Invoke-GithubScript -ScriptURL 'https://github.com/ComerTechnologyGroup/public-scripts/blob/main/Monitors/Windows/Active%20Directory/Get-AD-Default_OU_Object_Count.ps1'
